...
GMM_PARAMS = GMMParams(
    gmm_weights=np.array([
        0.19519483, 0.03632081, 0.10158541, 0.0377207,
        0.1930034, 0.09585493, 0.05098616, 0.08434407,
        0.05962311, 0.09534943, 0.05001716
    ]),

    gmm_means=np.array([
        [-0.85136621, -0.24148004, -0.70421087],
    ...
    gmm_covariances=np.array([
        [[2.46707022e-02, -1.23853834e-03, -1.96850265e-02],
...
class HClassModel(object):
    ...
    def __init__(self):
        ...
        self.cluster_labels = {0: 'F', 1: 'B', 2: 'I', 3: 'C', 4: 'G', 5: 'J',
                               6: 'H', 7: 'A', 8: 'K', 9: 'E', 10: 'D'}
        ...
        self.gmm_weights = GMM_PARAMS.gmm_weights
        self.gmm_means = GMM_PARAMS.gmm_means
        self.gmm_covariances = GMM_PARAMS.gmm_covariances
